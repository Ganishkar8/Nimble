export const language = [
  {
    en: {
      ...
      str_loanpurposecategory: 'LOAN PURPOSE CATEGORY',
      ...
      str_loanpdtracker: 'Personal Discussion Tracker',
      str_loanpddetails: 'Personal Discussion Details',
      str_laonappid: 'Loan Application ID',
      str_laonappdate: 'Loan Application Date',
      str_workflowstage: 'Workflow Stage',
      str_workflowstageId: 'Workflow ID',
      ...
      str_proceed: 'Proceed',
      str_reject: 'Reject',
      str_traveldetails: 'Travel Details',
      ...
      str_pd: 'Personal Discussion',
      str_app: 'Applicant',
      str_capp: 'Co-Applicant',
      str_g: 'Guarantor',
      str_basic_details_optional: 'Basic Details Optional',
      str_remarks: 'Remarks',
      str_responses: 'RESPONSE',
      ...
      str_checkCBResponse: 'Check CB Response',
